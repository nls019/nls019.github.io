...
export default class SpotLight extends Light {
  constructor(intensity = [1, 1, 1], position = [0, 0, 0], direction = [0, 1, 0], attenuation = [1, 0.1, 0.01], cutoff = 0.785, shading = 0, shadows = 0) {
    super();
    for (let i = 0; i < 3; ++i) {
    ...
    // tells the shader what type of light this is, and which shading algorithm to use 
    // 2 = spot
    this._params[2] = 2;
