...
export default class Camera {
  constructor() {
    ...
    this._position = [-1, 1, 1, -1]; // Left Right Up Down
    this._scale = 1;
  }
  ...
  zoomIn() {
    ...
    this._position[2] /= 1.1;
    this._position[3] /= 1.1;
    console.log(this._position);
  }
  
  zoomOut() {
    if (this._position[0] * 1.1 >= -1 && this._position[1] * 1.1 <= 1 && this._position[2] * 1.1 <= 1 && this._position[3] * 1.1 >= -1) {
      this._pose[4] /= 1.1;
      this._pose[5] /= 1.1;
      this._position[0] *= 1.1;
      this._position[1] *= 1.1;
