...
async function init() {
  ...
  var mesh = new CameraTriangleMeshLinearInterpolationObject(renderer._device, renderer._canvasFormat, '/Quest10/assets/SHREC19/6.ply', '/Quest10/assets/SHREC19/5.ply', camera);
